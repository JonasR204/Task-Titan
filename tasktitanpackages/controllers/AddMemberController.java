...
/**
 * Controller for the Add Member:
 * it handles user input, validates member information,
 * adds new team members to the database and closes the form.
 */
public class AddMemberController {
    ...
    /**
     * Used to refresh the members table after a new member is added.
     */
